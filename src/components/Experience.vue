<template>
    <panel title="PROFESSIONAL EXPERIENCE">
        <v-card flat v-for="Experience in Experiences" :key="Experience.id">
            <v-card-title>
                <p>
                    <v-badge color="cyan" :content="`${Experience.from} - ${Experience.to}`">
